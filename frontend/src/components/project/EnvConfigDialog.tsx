            ...
            {loading ? (
              ...
              <>
                <div className="bg-glass border border-glass-border rounded-lg p-4 space-y-4">
                  <div>
                    <h3 className="text-sm font-bold text-foreground">韭菜盒子</h3>
                    <p className="text-[0.625rem] text-text-muted mt-1">图片、视频和文本模型 API</p>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => handleChange("JIUCAIHEZI_API_KEY", e.target.value)}
                      placeholder="韭菜盒子 API Key"
                      className={inputClass}
                    />
                  </div>
                </div>
