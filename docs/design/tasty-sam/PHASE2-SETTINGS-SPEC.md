...
> 分支:`feat/atelier-pilot-20260611-161001`(已推 github `liuyunlong2021-wq/1ok-studio`)。日期 2026-06-17。
...
- 提交作者 Mike4Ellis;只推 `github`(=公开 liuyunlong2021-wq/1ok-studio),push 前敏感扫描。
...
**⑥ 关于(FE)**:(a)去掉「LINE B · LUMINOUS ATELIER」;(b)**检查更新**:手动按钮 → fetch `api.github.com/repos/liuyunlong2021-wq/1ok-studio/releases/latest` → 比对 `v0.2.0` → 有新版显示版本 + 按钮打开 releases 页(不自更新;纯前端;GitHub 未授权限流 ~60/hr)。
...
- **待办**:等用户下一轮设置页反馈;满意后一次性推 github `liuyunlong2021-wq/1ok-studio`(**推前敏感扫描**)。
