...
SUPPORTED_SELECTION_GROUPS = ("text", "t2i", "i2i", "image", "i2v", "r2v", "t2v")
...
DEFAULT_MODEL_SURFACE_REQUIREMENTS = {
    ...
    "text_model": ("project_settings", "series_settings", "global_settings"),
}
...
def build_catalog_dict(catalog_root: Optional[Path] = None) -> Dict[str, Any]:
    ...
    text_default = _require_non_empty_str(
        default_model_settings.get("text_model"),
        label="defaults.model_settings.text_model",
    )
    ...
    for model_id in (t2i_default, i2i_default, image_default, i2v_default, text_default):
    ...
    canonical_defaults = {
        ...
        "text_model": legacy_model_ids[text_default],
    }
    if r2v_default:
