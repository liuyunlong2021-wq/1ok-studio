...
| OSS_BUCKET_NAME | Bucket 名称 | `my-1okstudio-bucket` |
| OSS_ENDPOINT | OSS 地域节点 | `oss-cn-beijing.aliyuncs.com` |
| OSS_BASE_PATH | 存储路径前缀 | `1okstudio` |
...
A: One OK Studio 使用阿里云灵积平台的 AI 模型进行图像和视频生成。API Key 用于验证您的身份并计费。
